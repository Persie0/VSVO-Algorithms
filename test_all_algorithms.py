...
from scripts.CristiansAlgorithm import cristians_algorithm
...
print("\n2. NTP ALGORITHM")
from scripts.NTPAlgorithm import ntp_algorithm
...
print("\n3. BULLY ALGORITHM")
from scripts.BullyAlgorithm import bully_election
...
from scripts.TwoPhaseCommit import two_phase_commit
...
from scripts.ThreePhaseCommit import three_phase_commit
...
# Test 7: Paxos
print("\n7. PAXOS CONSENSUS")
from scripts.PaxosAlgorithm import paxos_round
...
print("\n8. DNS RESOLUTION")
from scripts.DNSResolution import iterative_resolution
